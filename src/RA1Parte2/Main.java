...
public class Main {
    ...
    public static void main(String[] args) {
        RA1Parte2.CuentaBancaria cuenta = cargarCuenta();
    ...
    private static RA1Parte2.CuentaBancaria cargarCuenta() {
        ...
        if (archivo.exists()) {
            try (ObjectInputStream ois = new ObjectInputStream(new FileInputStream(archivo))) {
                ...
                return (RA1Parte2.CuentaBancaria) ois.readObject();
            } catch (Exception e) {
    ...
    private static RA1Parte2.CuentaBancaria crearNuevaCuenta() {
        ...
        RA1Parte2.Cliente cliente = new Cliente(dni, nombre);
        System.out.println("Cuenta creada correctamente.");
        // no cerramos System.in Scanner para evitar cerrar System.in globalmente
        return new RA1Parte2.CuentaBancaria(cliente);
    }
