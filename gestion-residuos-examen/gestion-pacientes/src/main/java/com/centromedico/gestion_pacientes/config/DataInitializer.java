...
public class DataInitializer implements CommandLineRunner {
    ...
    private void crearUsuariosDePrueba() {
        ...
        admin.setEmail("admin@residuos.com");
        ...
        coordinador.setEmail("coordinador@residuos.com");
        coordinador.setPasswordHash(passwordEncriptado);
        coordinador.setNombre("Dr. Juan García Pérez");
        coordinador.setRol(Rol.COORDINADOR);
        coordinador.setActivo(true);
        usuarioRepository.save(coordinador);
        System.out.println("Usuario creado: coordinador (COORDINADOR)");
...
//     */
//    private void crearCamionesDePrueba(Usuario drGarcia, Usuario draLopez) {
